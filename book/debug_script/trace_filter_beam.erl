...
ListModeDelete=[rabbit_env, rabbit_logger_std_h, rabbit_prelaunch_early_logging, rabbit_prelaunch_logging, rabbit_semver_parser].

ListMod=ListModAll--ListModeDelete.
